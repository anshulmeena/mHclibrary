...
<div id="topbar">
	<div id="title">Elkridge Branch</div>
	  	<div id="leftnav">
	    <a href="index.php">
...
<div id="content">
	...
	<ul class="pageitem">
		<li class="textbox">
			...
			Mon-Thu (10 am - 9 pm)<br/>Fri-Sat (10 am - 6 pm)<br/>
			* Sun (1 pm - 5 pm)<br/><br/>
			* Open Sundays beginning September 12, 2010 through June 12, 2011.<br/>
...
<div id="footer">
	&copy; <?php echo date("Y");?> Howard County Library<br />
